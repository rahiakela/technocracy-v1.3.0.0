                                                                                                ...
                                                                                                <td>
                                                                                                    <div class="contentEditableContainer contentTextEditable">
                                                                                                        <div class="contentEditable">
                                                                                                            ...
                                                                                                            <p>Thanks for using <strong>Technocracy</strong>. This blog is just written by you on ${moment(blog.createdOn).format('LLLL')} but your blog is not approved due some ambiguas and inappropriate content, so please review and edit your blog and submit it again.</p>
                                                                                                            <br/>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </td>
