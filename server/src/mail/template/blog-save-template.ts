...
export class BlogSaveMailTemplate {

    public static getSaveBlogMailTemplate(blog: any): string {
        let content = `
                                                                                        ...
                                                                                        <tr>
                                                                                            <td>
                                                                                                <div class="contentEditableContainer contentTextEditable">
                                                                                                    <div class="contentEditable">
                                                                                                        <br/>
                                                                                                        <p>To <strong>Editors</strong>,</p>
                                                                                                        <p>This blog is just written by <strong>${blog.profile.name}</strong> on <strong>${moment(blog.createdOn).format('LLLL')}</strong>.He is waiting for approval of this blog, so please have a look and approve and mark it published.</p>
                                                                                                        <br/>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </td>
                                                        ...
                                                        <td valign="top" class="specbundle2"><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" >
                                                            ...
                                                            <tr>
                                                                <td align='right' valign='top'>
                                                                    <div class="contentEditableContainer contentTextEditable">
                                                                        <div class="contentEditable" >
                                                                            <a target='_blank' href="http://www.tecknocracy.com/blog/${blog._id}" class='link1'>Review →</a>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            </tr>
