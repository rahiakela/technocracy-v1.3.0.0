...
export class CommentMailTemplate {

  public static getCommentMailTemplate(mailOptions: Map<string, any>, recipient: string, notifyType: string): string {
    let _id =
      notifyType === 'blog'
        ? mailOptions.get('blog')._id
        : mailOptions.get('question')._id;
    let title =
      notifyType === 'blog'
        ? mailOptions.get('blog').title
        : mailOptions.get('question').title;
                                                                    ...
                                                                    <tr>
                                                                                ...
                                                                                <div class="contentEditable" >
                                                                                    <img src="${
                                                                                      process
                                                                                        .env
                                                                                        .CLOUD_IMAGE_PATH
                                                                                    }/images/favicon.ico" style="width: 80px; height: 70px;" alt='Compagnie logo' data-default="placeholder" data-max-width="300" width='129' height='22'>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        ...
                                                                        <td align='left' valign='top' >
                                                                            <div class="contentEditableContainer contentTextEditable" style='display:inline-block;'>
                                                                                <div class="contentEditable" >
                                                                                    <h3 style="font-size: x-large; color: #f0f8ff;">Technocracy Forum</h3>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        <td  align='left' style="width: 130px; padding-top: 45px;" >
                                                                            <div class="contentEditableContainer contentImageEditable" style='display:inline-block;'>
                                                                                <div class="contentEditable" >
                                                                                    <p>${DateTimeUtils.getDateString()}</p>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td>
                                                                                                <div class="contentEditableContainer contentTextEditable">
                                                                                                    <div class="contentEditable">
                                                                                                        <br/>
                                                                                                        <p><strong>${UserUtils.getUserName(
                                                                                                          mailOptions.get(
                                                                                                            'user'
                                                                                                          )
                                                                                                        )}</strong> commented on <strong><a href="https://www.tecknocracy.com/#/${notifyType}/${_id}" style="color:#007db8;">${title}</a></strong> ${notifyType}:</p><br/>
                                                                                                        `;
    if (mailOptions.get('reply')) {
      content += `
                                                                                                        <p>in response to <strong>${UserUtils.getUserName(
                                                                                                          mailOptions.get('comment').commentedBy
                                                                                                        )}</strong>:</p>
                                                                                                        <blockquote style="font-family: Times, serif;font-size: 1.1em;font-style: italic;color: #878787;border-left: 3px solid #ccc;margin: 1em 1em 1em 2em;padding-left: 1em;">
                                                                                                            <p style="color: #007db8;font-weight: bold;">${UserUtils.decodeHTML(
                                                                                                              mailOptions.get('comment').content
                                                                                                            )}</p>
                                                                                                        </blockquote>
        `;
    }
    if (mailOptions.get('reply')) {
      content += `
                                                                                                        <p style="color: #007db8;font-weight: bold;">${UserUtils.decodeHTML(mailOptions.get('reply').content)}</p>
        `;
    } else {
      content += `
                                                                                                        <p style="color: #007db8;font-weight: bold;">${UserUtils.decodeHTML(
                                                                                                          mailOptions.get('comment').content)}</p>
        `;
    }
    content += `
                                                                                                        <br/>
                                                                            ...
                                                                            <tr>
                                                                                <td align='right' valign='top'>
                                                                                    <div class="contentEditableContainer contentTextEditable">
                                                                                        <div class="contentEditable" >
                                                                                            <a target='_blank' href="http://www.tecknocracy.com/#/${notifyType}/${_id}" class='link1'>Reply →</a>
                                                                                        </div>
                                                                                    </div>
                                                                                </td>
                                                                            </tr>
