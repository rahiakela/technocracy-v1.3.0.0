...
export class PasswordResetTemplate {
    ...
    public static getPasswordResetTemplate(username: string, recipient: string, verifyToken: any): string {
        let content = `
        <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
        <html xmlns="http://www.w3.org/1999/xhtml">
        <head>
            <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
            <title>Technocracy Forum</title>
            <style type="text/css">
                body {
                                                                                        ...
                                                                                        <tr>
                                                                                            <td>
                                                                                                <div class="contentEditableContainer contentTextEditable">
                                                                                                    <div class="contentEditable">
                                                                                                        <br/>
                                                                                                        <p style="color:#007db8;font-weight: bold;">Dear ${username}</p><br/>
                                                                                                        <p>A password resetting request is asked for your Technocracy account, so please follow the below instructions.</p><br/>
                                                                                                        <p>Click the following link to reset the password for your Technocracy account:</p>
                                                                                                        <p><a style="color:#007db8;" href="https://www.tecknocracy.com/account/reset/pass?token=${
            verifyToken.token
            }">https://www.tecknocracy.com/account/reset/pass?token=${
            verifyToken.token
            }</a></p><br/>
