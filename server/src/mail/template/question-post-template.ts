                                                                                            ...
                                                                                            <td>
                                                                                                <div class="contentEditableContainer contentTextEditable">
                                                                                                    <div class="contentEditable">
                                                                                                        ...
                                                                                                        <p>This question is just asked by <strong>${askedByUser}</strong> on ${moment(
      question.createdOn
    ).format(
      'LLLL'
    )}.He is waiting for approval of this question, so please have a look and approve and mark it published.</p>
                                                                                                        <br/>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </td>
