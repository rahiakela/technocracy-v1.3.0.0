...
export class MailActivateTemplate {

  public static getMailActivateTemplate(recipient: string, verifyToken: any): string {
    let content = `
                                                                                        ...
                                                                                        <tr>
                                                                                            <td>
                                                                                                <div class="contentEditableContainer contentTextEditable">
                                                                                                    <div class="contentEditable">
                                                                                                        <br/>
                                                                                                        <p style="color:#007db8;font-weight: bold;">Welcome to Technocracy Forum!</p><br/>
                                                                                                        <p>Click the following link to confirm and activate your new account:</p>
                                                                                                        <p><a style="color:#007db8;" href="https://www.tecknocracy.com/account/verify?token=${
                                                                                                          verifyToken.token
                                                                                                        }">https://www.tecknocracy.com/account/verify?token=${
      verifyToken.token
    }</a></p><br/>
