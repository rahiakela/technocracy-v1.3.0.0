...
export class ProdErrorTemplate {

  public static getProdErrorTemplate(recipient: string, error: any): string {
    let content = `
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td align='left' valign='top' >
                                                                            <div class="contentEditableContainer contentTextEditable" style='display:inline-block;'>
                                                                                <div class="contentEditable">
                                                                                    <h3 style="font-size: larger; color: #f0f8ff;">Technocracy Production Error</h3>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        <td  align='left' style="width: 130px; padding-top: 45px;" >
                                                                            <div class="contentEditableContainer contentImageEditable" style='display:inline-block;'>
                                                                                <div class="contentEditable" >
                                                                                    <p id="date">${DateTimeUtils.getDateString()}</p>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td>
                                                                                                <div class="contentEditableContainer contentTextEditable">
                                                                                                    <div class="contentEditable">
                                                                                                        <br/>
                                                                                                        <p>Hey <strong>Administrator</strong>,</p>
                                                                                                        <p>This error is just occurred in production environment on {datetime}.Please check this issue and analyze the impact of this problem in production server.</p>
                                                                                                        <br/>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </td>
                                                ...
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" >
                                                    <tr>
                                                        <td style='border-bottom-left-radius:3px;border-bottom-right-radius:3px;' align='left'>
                                                            <div class="contentEditableContainer contentTextEditable" style='display:inline-block;'>
                                                                <div class="contentEditable" >
                                                                    <h4 style="color: #007db8; font-family: inherit;"><a href="#" style="text-decoration: none;color: currentColor;">${
                                                                      error.message
                                                                    }</a></h4>
                                                                </div>
                                                            </div>
